...
bool LoadPlyXFileIntoMesh(std::string filename, cMesh &theMesh)
{
	std::ifstream plyFile(filename.c_str());
	...
	plyFile >> discard; //NumberOfTriangles
	plyFile >> discard; //=
	plyFile >> theMesh.numberOfTriangles;
	...
	plyFile >> discard; //NumberOfVertices
	plyFile >> discard; //=
	plyFile >> theMesh.numberOfVertices;
	...
	plyFile >> discard; //Check and see if it says EndOfFile
