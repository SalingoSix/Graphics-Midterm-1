...
glm::vec3 g_cameraXYZ = glm::vec3(-513.386414f, 106.100113f, -2090.32959f);
glm::vec3 g_cameraTarget_XYZ = glm::vec3(0.274823606f, 105.980118f, 0.961494684f);
...
int main()
{
	...
	{	//Load each file into a VAO object
		...
		if (!LoadPlyXFileIntoMesh(plyDirects[i], newMesh))
		{
	...
	//For Midterm Question 7

	//GLint uniLoc_materialDiffuse = glGetUniformLocation(currentProgID, "materialDiffuse");

	GLint uniLoc_materialDiffuse_r = glGetUniformLocation(currentProgID, "materialDiffuse_r");
	GLint uniLoc_materialDiffuse_g = glGetUniformLocation(currentProgID, "materialDiffuse_g");
	GLint uniLoc_materialDiffuse_b = glGetUniformLocation(currentProgID, "materialDiffuse_b");
	GLint uniLoc_materialDiffuse_a = glGetUniformLocation(currentProgID, "materialDiffuse_a");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (int index = 0; index != sizeOfVector; index++)
		{
			...
			glUniform1f(uniLoc_materialDiffuse_r, ::g_vecGameObject[index]->diffuseColour.r);
			glUniform1f(uniLoc_materialDiffuse_g, ::g_vecGameObject[index]->diffuseColour.g);
			glUniform1f(uniLoc_materialDiffuse_b, ::g_vecGameObject[index]->diffuseColour.b);
			glUniform1f(uniLoc_materialDiffuse_a, ::g_vecGameObject[index]->diffuseColour.a);
